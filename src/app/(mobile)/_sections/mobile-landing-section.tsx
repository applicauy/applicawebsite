...
export default function MobileLandingSection() {
    ...
    return (
        <Section className="py-5 md:py-24">
            <div
                ref={ref}
                className={`mdplus:max-w-[66%] relative transition-all duration-1000 ease-out transform ${
                    inView ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-5"
                }`}
            >
                <H1 className="mb-5 text-center md:mt-20">
                    We turn{" "} 
                    <span
                ...
                <div className="text-xl md:text-2xl mdplus:text-4xl w-full mb-12 text-center">
