...
import MobileHealthcareHeroSection from "../(mobile)/_sections/landings/mobile-healthcare-hero-section";
import MobileHealthcareServicesSection from "../(mobile)/_sections/landings/mobile-healthcare-services-section";
import MobileHealthcareIndustriesSection from "../(mobile)/_sections/landings/mobile-healthcare-industries-section";
import MobileHealthcareChallengeSection from "../(mobile)/_sections/landings/mobile-healthcare-challenge-section";
import MobileHealthcareKeyTechnologySection from "../(mobile)/_sections/landings/mobile-healthcare-key-technology-section";
import MobileHealthcareCaseStudySection from "../(mobile)/_sections/landings/mobile-healthcare-case-study-section";
import { MobileHealthcareWhyUsSection } from "../(mobile)/_sections/landings/mobile-healthcare-why-us-section";
import { MobileHealthcareFaqsSection } from "../(mobile)/_sections/landings/mobile-healthcare-faqs-section";
import { MobileHealthcareBlogSection } from "../(mobile)/_sections/landings/mobile-healthcare-blog-section";
import { MobileHealthcareLetsTalkSection } from "../(mobile)/_sections/landings/mobile-healthcare-lets-talk-section";
...
export default function HealthcarePageClientWrapper() {
    ...
    return (
        <main className={`${apexFont.className} flex flex-col gap-8 lg:gap-12 overflow-hidden ${ width <= 768 && 'bg-white' }`}>
