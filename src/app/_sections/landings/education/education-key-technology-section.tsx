...
export const EducationKeyTechnologySection = () => {
  ...
  return (
    <Section className={`${rubikFont.className} relative`}>
        <FadeIn>
            ...
            <div className="max-w-screen-md text-xl lg:text-2xl xl:text-3xl text-black leading-tight mt-12">
                <p>
...
export default EducationKeyTechnologySection;
