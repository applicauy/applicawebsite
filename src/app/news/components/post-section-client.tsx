...
const PostSectionClient = (
    ...
    return (
        <div className={`${apexFont.className} flex min-h-screen flex-col items-start justify-between md:px-4 lg:px-24 lg:mt-10 mt-24 overflow-hidden ${ isMobile && 'mb-16' }`}>
