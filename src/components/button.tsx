...
export default function Button({
    ...
    return (
        ...
        (
            <button
                onClick={ handleClick }
                className={`flex hover:cursor-pointer content-center pe-2.5 md:pe-4 ps-6 md:ps-9 py-2 items-center border ${ highlightedArrow ? 'border-highlight' : 'border-white' } rounded-full font-medium w-fit ${ largeText ? 'text-4xl' : 'text-3xl' } leading-none transition-all duration-300 ${ highlightedArrow ? 'hover:bg-highlight' : 'hover:bg-white' } hover:text-black`}
                type={ type }
                disabled={ disabled }
